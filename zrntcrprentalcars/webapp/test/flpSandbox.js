		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RentalCars",
									"targetURL": "#zrntcrprentalcars-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zrntcrprentalcars-display": {
								"semanticObject": "zrntcrprentalcars",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zrntcrprentalcars",
									"url": sap.ui.require.toUrl("zrntcrprentalcars")
								}
							}
						}
					}
